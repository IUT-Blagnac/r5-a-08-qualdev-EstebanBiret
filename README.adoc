...
---
include::cucumber_demo/target/cukedoctor/documentation.adoc[]
---

Véritable rapport (serenity) :


Lien vers le rapport html : https://htmlpreview.github.io/?https://github.com/IUT-Blagnac/r5-a-08-qualdev-EstebanBiret/serenity/index.html
